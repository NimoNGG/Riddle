...
const quizzes = [
    ...
    { title: "第二の記録", question: `森の名を冠した門をくぐり、光で作られし幻影の世界へ。<br>特殊な眼鏡をかければ、ここではないどこかへと旅立てるだろう。<br>幻影世界への案内人が持つ「許可証」に、次の言葉は記されている。`, answer: "ダイブ", keyword: "管理者を『番人』と呼び<br>声をかけろ" },
    { title: "第三の記録", question: `第三の学び舎にて、一瞬の時を永遠に封じ込める小部屋を探せ。<br>目映い光と共に、君の姿は一枚の紙へと転写される。<br>その小部屋を覆う帳（とばり）に、賢人の言葉は縫い付けられている。`, answer: "メモリア", keyword: "自身のことを<br>『革命家』と名乗れ" },
    { title: "第四の記録", question: `再び、第三の学び舎へ。若きアスリートたちの汗と栄光が刻まれた壁がある。<br>数多の激戦を伝える紙の中で、最も新しき勝利の雄叫びを見つけよ。<br>その見出しこそが、次への道しるべとなる。`, answer: "ヘッドライン", keyword: "あいことばは<br>『正義の均衡をもう一度』" },
...
const scenarios = [
    ...
    { title: "第六章：最後の行動", text: "すべての試練を乗り越えた君に、番人たちは最後の問いを投げかける。\n天秤の前に立った時、君はどう行動するのか。<br>力で支配するのか、知恵で導くのか、それとも…。<br>真に世界の均衡を願う者ならば、自ずと答えは分かるはずだ。\nもし君が天秤の歪みを正し、その傾きを等しくすることができたなら、その時こそ君は真の革命家…『正義を革命せし者』として歴史に認められるだろう。<br>未来は、君の最後の選択にかかっている。" },
...
function checkAnswer() {
    ...
    if (userAnswer === correctAnswer) {
        ...
        if (quizId > currentSolvedCount) {
            resultMessage += `また新たな物語とシナリオが<br>解放された。<br>`;
...
function displaySummary() {
    ...
    if (solvedCount >= quizzes.length) {
        ...
        finalMessage.innerText = "この手がかりをもとに<br>失われた天秤を<br>探しに行こう";
