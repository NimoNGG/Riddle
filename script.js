...
// =============================================
const quizzes = [
    { title: "第一の記録", question: `学舎（まなびや）と学舎を繋ぐ大いなる橋。その影となりし場所に目を向けよ。<br>異国の文字が踊る店で、春雨を用いた宴が催されている。<br>その店の品書きにこそ、賢人の言葉は隠されている。`, answer: "クロスロード", keyword: "第一の賢人の記録<br>『3204』に向かえ" },
    { title: "第二の記録", question: `森の名を冠した門をくぐり、光で作られし幻影の世界へ。<br>特殊な眼鏡をかければ、ここではないどこかへと旅立てるだろう。<br>幻影世界への案内人が持つ「許可証」に、次の言葉は記されている。`, answer: "ダイブ", keyword: "第二の賢人の記録<br>管理者を『番人』と呼び<br>声をかけろ" },
    { title: "第三の記録", question: `第三の学び舎にて、一瞬の時を永遠に封じ込める小部屋を探せ。<br>目映い光と共に、君の姿は一枚の紙へと転写される。<br>その小部屋を覆う帳（とばり）に、賢人の言葉は縫い付けられている。`, answer: "メモリア", keyword: "第三の賢人の記録<br>自身のことを<br>『革命家』と名乗れ" },
    { title: "第四の記録", question: `再び、第三の学び舎へ。若きアスリートたちの汗と栄光が刻まれた壁がある。<br>数多の激戦を伝える紙の中で、最も新しき勝利の雄叫びを見つけよ。<br>その見出しこそが、次への道しるべとなる。`, answer: "ヘッドライン", keyword: "第四の賢人の記録<br>あいことばは<br>『正義の均衡をもう一度』" },
    { title: "第五の記録", question: `第五の探求の館へ向かえ。そこには富の流れと社会の理（ことわり）を追う者たちが集う。<br>彼らの英知の源たる書物、その「活動記録」と題された最初の頁に言葉は眠る。`, answer: "アセット", keyword: "第五の賢人の記録<br>錠の暗号は『1034』" },
    { title: "第六の記録", question: `再び、大いなる橋の影へ。冷えた体を温める湯気が立ち上る場所がある。<br>黄金の出汁に浸かる数々の宝。その中で、最も清き白亜の円が示すものこそ最後の言葉だ。`, answer: "ホット", keyword: "第六の賢人の記録<br>『天秤の傾きを等しくする』<br>行動をとれ" }
];
const scenarios = [
    ...
    { title: "終章：未来への選択", text: "君の行動により、天秤はついにその輝きを取り戻した。…こちらでも、未来の崩壊が完全に停止したのを確認した。本当にありがとう。君は我々の世界を、そして学び舎の未来を救ってくれたのだ。だが、物語はこれで終わりではない。取り戻された均衡は、脆く儚いガラス細工のようなものだ。それを守り続けるのは、未来からの干渉者である我々ではなく、いつの時代も「今」を生きる君たち自身なのだ。どうか、その胸にある正義の心を忘れず、輝かしい未来を歩んでほしい。我々は、君の時代の行く末を見守っている。" }
];
...
function checkAnswer() {
    ...
    if (userAnswer === correctAnswer) {
        ...
        let resultMessage = `封印を解除し<br>賢人の記録を入手した。<br>`;
        ...
        if (quizId === 6) {
            resultMessage += `<br>手に入れた手がかりを一覧で見てみよう！`;
        }
