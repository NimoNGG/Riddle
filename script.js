...
const quizzes = [
    ...
    { title: "第五のエニグマ", question: `学舎（まなびや）と学舎を繋ぐ大いなるデッキ。その影となりし場所に目を向けよ。異国の春雨を用いた料理が提供されている。<br>本場料理人が働くその店に、賢人の言葉は隠されている。<br><span class="question-highlight">※すでにこのブースは閉まってしまっているため、合言葉をこちらに記入します。<br>合言葉：マシッソヨ</span>`, answer: "マシッソヨ", keyword: "錠の暗号は『1034』" },
    { title: "第六のエニグマ", question: `大いなる舞台を背に、冷えてしまった身体を温める湯気が立ち上ぼっている。そこには黄金の出汁に浸かる数々の宝が隠されている。<br>疲れを癒し身体の芯から温まることができるその場所に、最後の言葉は眠る。<br><span class="question-highlight">※すでにこのブースは閉まってしまっているため、合言葉をこちらに記入します。<br>合言葉：コア</span>`, answer: "コア", keyword: "『天秤の傾きを等しくする』<br>行動をとれ" }
];
const scenarios = [
