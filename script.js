...
function checkAnswer() {
    ...
    if (userAnswer === correctAnswer) {
        ...
        if (quizId > currentSolvedCount) {
            resultMessage += `また新たなシナリオと手がかりが<br>解放された。<br>`;
