...
// =============================================
const quizzes = [
    { title: "第一のエニグマ", question: `学舎（まなびや）と学舎を繋ぐ大いなる橋。その影となりし場所に目を向けよ。異国の春雨を用いた料理が提供されている。<br>本場料理人が働くその店に、賢人の言葉は隠されている。`, answer: "マシッソヨ", keyword: "『3204』に向かえ" },
    ...
    { title: "第三のエニグマ", question: `森の名を冠した門をくぐり、幻影の世界へ。特殊な眼鏡をかければ、ここではないどこかへと旅立てるだろう。<br>幻影世界への案内人が待つその部屋に、次の言葉は記されている。`, answer: "ダイブ", keyword: "自身のことを<br>『革命家』と名乗れ" },
    ...
    { title: "第五のエニグマ", question: `無から有を生み出す錬金術師たちの工房を探せ。彼らが操る回転する円卓の上で、土塊は新たな命を吹き込まれる。<br>自らもその工程を体験できるその場所にて、隠されし合言葉は秘められている。`, answer: "クリエイト", keyword: "錠の暗号は『1034』" },
    { title: "第六のエニグマ", question: `冷えてしまった身体を温める湯気が立ち上る場所がある。黄金の出汁に浸かる数々の宝。<br>疲れを癒し身体の芯から温まることができるその場所に、最後の言葉は眠る。`, answer: "コア", keyword: "『天秤の傾きを等しくする』<br>行動をとれ" }
];
const scenarios = [
