...
// =============================================
const quizzes = [
    { title: "第一のエニグマ", question: `森の名を冠した建物へ向かい、幻影の世界へ。特殊な眼鏡をかければ、ここではない世界にて遊戯を行えるだろう。<br>幻影世界への案内人が待つその部屋に、次の言葉は記されている。`, answer: "ダイブ", keyword: "『3204』に向かえ" },
    { title: "第二のエニグマ", question: `第三の学び舎へ向かへ。時の旅人たちが集う部屋を探せ。彼らは戦や遺物のみを扱うに非ず、無数の歴史的文献を紐解く。<br>それを現代に紡ぐ資料が数多く示されている部屋に、言葉は刻まれている。`, answer: "クロニクル", keyword: "管理者を『番人』と呼び<br>声をかけろ" },
    ...
    { title: "第五のエニグマ", question: `学舎（まなびや）と学舎を繋ぐ大いなるデッキ。その影となりし場所に目を向けよ。異国の春雨を用いた料理が提供されている。<br>本場料理人が働くその店に、賢人の言葉は隠されている。`, answer: "マシッソヨ", keyword: "錠の暗号は『1034』" },
    { title: "第六のエニグマ", question: `大いなる舞台を背に、冷えてしまった身体を温める湯気が立ち上ぼっている。そこには黄金の出汁に浸かる数々の宝が隠されている。<br>疲れを癒し身体の芯から温まることができるその場所に、最後の言葉は眠る。`, answer: "コア", keyword: "『天秤の傾きを等しくする』<br>行動をとれ" }
];
const scenarios = [
