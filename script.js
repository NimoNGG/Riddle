...
// =============================================
const quizzes = [
    { title: "第一のエニグマ", question: `学舎（まなびや）と学舎を繋ぐ大いなるデッキ。その影となりし場所に目を向けよ。異国の春雨を用いた料理が提供されている。<br>本場料理人が働くその店に、賢人の言葉は隠されている。`, answer: "マシッソヨ", keyword: "『3204』に向かえ" },
    ...
    { title: "第三のエニグマ", question: `森の名を冠した建物へ向かい、幻影の世界へ。特殊な眼鏡をかければ、ここではないどこかへと旅立てるだろう。<br>幻影世界への案内人が待つその部屋に、次の言葉は記されている。`, answer: "ダイブ", keyword: "自身のことを<br>『革命家』と名乗れ" },
    { title: "第四のエニグマ", question: `再び、第三の学び舎へ。時の旅人たちが集う部屋を探せ。過去の記録を紐解き、未来を憂う彼らの研究の成果がそこにある。<br>彼らが編纂せし歴史の書が多く残されているその部屋に、言葉は刻まれている。`, answer: "クロニクル", keyword: "革命は<br>『正義の下（もと）にあり』" },
