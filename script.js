...
// =============================================
const quizzes = [
    { title: "第一の記録", question: `学舎（まなびや）と学舎を繋ぐ大いなる橋。その影となりし場所に目を向けよ。<br>異国の文字が踊る店で、春雨を用いた宴が催されている。<br>その店の品書きにこそ、賢人の言葉は隠されている。`, answer: "クロスロード", keyword: "第一の賢人の記録：『3204』に向かえ" },
    { title: "第二の記録", question: `森の名を冠した門をくぐり、光で作られし幻影の世界へ。<br>特殊な眼鏡をかければ、ここではないどこかへと旅立てるだろう。<br>幻影世界への案内人が持つ「許可証」に、次の言葉は記されている。`, answer: "ダイブ", keyword: "第二の賢人の記録：管理者を『番人』と呼び声をかけろ" },
    { title: "第三の記録", question: `第三の学び舎にて、一瞬の時を永遠に封じ込める小部屋を探せ。<br>目映い光と共に、君の姿は一枚の紙へと転写される。<br>その小部屋を覆う帳（とばり）に、賢人の言葉は縫い付けられている。`, answer: "メモリア", keyword: "第三の賢人の記録：自身のことを『革命家』と名乗れ" },
    { title: "第四の記録", question: `再び、第三の学び舎へ。若きアスリートたちの汗と栄光が刻まれた壁がある。<br>数多の激戦を伝える紙の中で、最も新しき勝利の雄叫びを見つけよ。<br>その見出しこそが、次への道しるべとなる。`, answer: "ヘッドライン", keyword: "第四の賢人の記録：あいことばは『正義の均衡をもう一度』" },
    ...
    { title: "第六の記録", question: `再び、大いなる橋の影へ。冷えた体を温める湯気が立ち上る場所がある。<br>黄金の出汁に浸かる数々の宝。その中で、最も清き白亜の円が示すものこそ最後の言葉だ。`, answer: "ホット", keyword: "第六の賢人の記録：『天秤の傾きを等しくする』行動をとれ" }
];
const scenarios = [
    ...
    { title: "第四章：原初への回帰", text: "革命家に求められる資質、それは破壊ではない。失われたものを取り戻し、未来へ繋ぐ力だ。番人たちが真に望んだのは、創設者たちが掲げた原初の理念…『正義の均衡をもう一度』取り戻すことだった。いつからか忘れ去られてしまった、自由闊達な議論と、多様な価値観を認め合う寛容さ。形骸化した規則ではなく、学生一人ひとりの心の中に真の正義が息zuku学び舎を未来へ遺すことこそ、彼らが天秤に託した悲願だったのだ。" },
