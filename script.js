...
const quizzes = [
    ...
    { title: "第三の手がかり", question: `第三の学び舎にて、一瞬の時を永遠に封じ込める小部屋を探せ。<br>目映い光と共に、君の姿は一枚の紙へと転写される。<br>その小部屋を覆う帳（とばり）に、賢人の言葉は縫い付けられている。`, answer: "メモリア", keyword: "第三の賢人の記録：扉は『6回』叩き開け" },
    { title: "第四の手がかり", question: `再び、第三の学び舎へ。若きアスリートたちの汗と栄光が刻まれた壁がある。<br>数多の激戦を伝える紙の中で、最も新しき勝利の雄叫びを見つけよ。<br>その見出しこそが、次への道しるべとなる。`, answer: "ヘッドライン", keyword: "第四の賢人の記録：開門後の詠唱は『剣（つるぎ）なき秤（はかり）は無力（むりょく）、秤（はかり）なき剣（つるぎ）は暴力（ぼうりょく）』" },
